...
REGIONAL_WORDS = {
    ...
    "UTTAR", "DAKSHIN", "CENTRAL",
    "NORTHERN", "SOUTHERN", "EASTERN", "WESTERN"
}

INSURANCE_GENERAL = {"GENERAL", "GI", "INSURANCE", "NON-LIFE"}

FINANCE_WORDS = {"BANK", "FINANCE", "CAPITAL", "SECURITIES", "NBFC"}
PHARMA_WORDS = {"PHARMA", "HEALTH", "HEALTHCARE", "BIO", "MEDICAL"}
